# Contexto de Negócio - No Radar do Jarbis

## Visão Geral do Projeto
O "No Radar do Jarbis" (@noradardojarbis) é uma operação de renda extra baseada em canais de ofertas automatizados, focada na escala inicial de custo zero e expansão via reinvestimento estruturado.

## Parâmetros de Operação
- **Canal Oficial de Saída:** @noradardojarbis (Telegram)
...
5. **Supermercado (Alimentos e Bebidas):** Itens de supermercado, como batata frita (Pringles), salgadinhos, chocolates, biscoitos, petiscos e refrigerantes/bebidas.
...
- **Fase 2:** Geração de receita consistente para amortização de juros de passivos.
- **Fase 3:** Escala de tráfego orgânico (TikTok/Reels) e reinvestimento de 30% do lucro em anúncios pagos para crescimento exponencial do canal.